...
if(isset($_GET['sous_taches'])) {
  foreach($_GET['sous_taches'] as $id_sous_tache) {
    $sql    = "INSERT INTO `affectation` (`id`, `id_projet`, `id_tache`, `id_sous_tache`, `phase`, `date_max`, `date_max_timestamp`, `traitant`,  `ordre`, `statut`) VALUES ('', '".$id_projet."', '".$id_tache."', '".$id_sous_tache."', '".$phase."', '".$date_max."', '".$date_max_timestamp."', '".$traitant."',  '".$a."', 'à faire');";
    $result = mysqli_query($db, $sql);
    $a++;
  }
}else {
  $sql    = "INSERT INTO `affectation` (`id`, `id_projet`, `id_tache`, `id_sous_tache`, `phase`, `date_max`,  `date_max_timestamp`, `traitant`,  `ordre`, `statut`) VALUES ('', '".$id_projet."', '".$id_tache."', '', '".$phase."', '".$date_max."', '".$date_max_timestamp."', '".$traitant."', '".$a."', 'à faire');";
  $result = mysqli_query($db, $sql);
  echo $sql;
