...
if ($_GET['sous_tache'] != '') {
    $sql    = "INSERT INTO taches (id, nom) VALUES (NULL, '" . addslashes($_GET['sous_tache']) . "')";
    $result = mysqli_query($db, $sql);
} else if ($_GET['tache_de_base'] != '') {
    $sql      = "INSERT INTO taches (id, nom) VALUES (NULL, '" . addslashes($_GET['tache_de_base']) . "')";
    $result   = mysqli_query($db, $sql);
    ...
    $sql      = "UPDATE `taches` SET `nom` = '" . $_GET['tache_de_base_modification'] . "' WHERE `taches`.`id` = '" . $_GET['id_tache'] . "' ";
    $result   = mysqli_query($db, $sql);
