      ...
      <tbody>
        ...
        while($row = $result->fetch_array()) {
          ...
          while($row2 = $result2->fetch_array()) {
            array_push($tab_noms, $row2["collab_pname"].' '.$row2["collab_name"]);
          }
          ?>
          <tr>
            ...
            <td><?php echo $tab_noms[0]; ?></td>
            <td><?php echo $tab_noms[1]; ?></td>
            <td><?php echo $tab_noms[2]; ?></td>
            <td><?php echo $etat; ?></td>
        ...
        <div class="modal-body">
          <form id="mon_projet" name="mon_projet">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="manager" name="manager"  type="text" autocomplete="off">
